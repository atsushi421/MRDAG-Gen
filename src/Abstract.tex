\begin{abstract}
    ...
    MRDAG-Gen also enables batch generation of random DAG sets with different parameters.
    Case studies are used to demonstrate that MRDAG-Gen can manage various problem settings and DAG study requirements.
\end{abstract}
